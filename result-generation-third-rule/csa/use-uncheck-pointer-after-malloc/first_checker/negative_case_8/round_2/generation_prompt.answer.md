I’m checking the available checker APIs and then I’ll wire the rule into the provided standalone plugin template, keeping it self-contained in one C++ file.```cpp
#include <memory>
#include <optional>
#include <vector>
