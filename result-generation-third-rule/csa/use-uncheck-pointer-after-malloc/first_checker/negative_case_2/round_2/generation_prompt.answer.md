I’m reading the available analyzer hooks and the template shape, then I’ll wire the checker into AST traversal with a small state machine for allocation, checks, and first use.```cpp
#include <memory>
#include <optional>
#include <string>
#include <utility>
