I’m checking the checker surface and the local analyzer APIs the template already uses, then I’ll wire the rule into the AST callback with the narrowest state I can keep in one file.```cpp
#include <memory>
#include <optional>
#include <set>
#include <string>
