I’m reading the available checker patterns and the plugin scaffold, then I’ll wire the rule into the AST callback with the narrowest possible state tracking.```cpp
#include <algorithm>
#include <memory>
#include <string>
#include <utility>
