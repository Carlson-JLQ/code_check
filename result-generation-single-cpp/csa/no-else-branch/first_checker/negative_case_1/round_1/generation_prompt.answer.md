I’m checking the local analyzer checker patterns and then I’ll wire the rule into the provided template, keeping it in one C++ file and using only the demonstrated CSA APIs.```cpp
