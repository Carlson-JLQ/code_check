I’m checking the checker body and will remove the invalid BugReporter call without changing the class or registration names. Then I’ll keep the report emission path as close as possible to the current AST-body implementation.```cpp
