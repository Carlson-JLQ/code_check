I’m switching the checker to use a valid AST-body report path and removing the bad `getErrorNode` call. I’m keeping the class and frontend names intact, and I’ll preserve the existing traversal logic unless it blocks compilation.```cpp
