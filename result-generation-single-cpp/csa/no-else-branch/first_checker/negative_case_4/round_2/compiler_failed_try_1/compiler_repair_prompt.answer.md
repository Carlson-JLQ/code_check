I’m fixing the two API mismatches directly in the checker implementation and keeping the public checker/frontend names untouched. After that I’ll do a quick compile-oriented sanity pass against the existing pattern.```cpp
