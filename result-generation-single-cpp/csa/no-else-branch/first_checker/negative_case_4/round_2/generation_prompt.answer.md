I’m inspecting the checker shape and the available CSA hooks, then I’ll wire the rule into the existing AST-body entry point so it stays self-contained.```cpp
