I’m reading the checker shape and available CSA hooks, then I’ll wire the rule into the template with the narrowest AST traversal that matches the requested diagnostic.```cpp
