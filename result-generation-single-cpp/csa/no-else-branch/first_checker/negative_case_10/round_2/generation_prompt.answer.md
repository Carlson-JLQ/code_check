I’m checking the local Clang Static Analyzer checker shape first, then I’ll wire the rule into the existing AST-body checker pattern and keep the implementation self-contained in one C++ file.```cpp
